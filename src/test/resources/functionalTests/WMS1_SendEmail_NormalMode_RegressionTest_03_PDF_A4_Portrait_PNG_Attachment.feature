...
Feature: RegressionTest_03_OP_NormaMode_SendEmail for WMS1 dashboard with attachment of PDF-Portrait and PNG files
This feature validate the send email functionality of OP Normal mode 

@RegressionTest
Scenario: RegressionTest_01_Testcase_10__NormaMode_Check that user is successfully able to export data in pdf-portrait and PNG actual Size format in OP Mode for WMS1 screen
...
And   select PDF Portrait as attachment
